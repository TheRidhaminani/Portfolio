    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          bg-orange-500/10 text-orange-400 text-sm tracking-wide border border-orange-500/20">
            ML Engineer · Data Analyst · GATE DS&AI Qualified
          </span>
          ...
          <p className="mt-5 text-gray-400 text-lg max-w-xl mx-auto md:mx-0">
            I build{" "}
            <span className="text-white">end-to-end AI systems</span> — from a
            CNN-LSTM signal classifier with{" "}
            <span className="text-orange-400 font-medium">90%+ accuracy</span>{" "}
            to RAG chatbots, fraud detectors, and interactive Power BI dashboards.
          </p>
          ...
          {/* Mobile socials */}
          <div className="flex gap-3 justify-center md:hidden mt-8">
            {socials.map((item, i) => (
              <a
                key={i}
                href={item.link}
